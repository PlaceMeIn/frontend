<template>
  <section class="min-h-screen bg-gradient-to-b from-primary-50/40 via-white to-white dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-900">
    <div class="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
      <div class="overflow-hidden rounded-3xl border border-primary-100 bg-white/90 shadow-sm ring-1 ring-black/5 backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/80">
        <div class="grid gap-8 px-6 py-8 lg:grid-cols-[1.4fr_0.8fr] lg:px-8 lg:py-10">
          <div class="space-y-5">
      ...
      <template v-else>
        ...
        <div
          v-if="members.length"
          class="grid grid-cols-2 gap-3 sm:gap-4 xl:grid-cols-3"
        >
          <UCard
            v-for="member in members"
            :key="member.id"
            :ui="{
              root: 'h-full overflow-hidden border border-gray-200/80 bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-900',
              body: 'p-0'
            }"
          >
